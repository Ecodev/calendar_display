...
/**
 * This view helper generates a <select> dropdown list with prependOption for the use with a form.
 *
 * = Basic usage =
 *
 ...
 * @api
 */
class Tx_CalendarDisplay_ViewHelpers_Form_SelectViewHelper extends Tx_Fluid_ViewHelpers_Form_AbstractFormFieldViewHelper {
	...
	protected function getOptions() {
		...
		if ($this->arguments->hasArgument('prependOption')) {
			$options = array(0 => $this->arguments['prependOption']) + $options;
		}
		return $options;
	}
